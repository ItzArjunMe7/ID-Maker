  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-8">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-center w-full">
            <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-200 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-blue-50 hover:border-blue-200 transition-all">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                {data.signatureUrl ? (
                  <img src={data.signatureUrl} className="h-12 object-contain mb-2" alt="Preview" />
                ) : (
                  <svg className="w-10 h-10 mb-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                )}
      ...
      <div className="pt-4">
        <button 
          onClick={onSubmit}
          className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-extrabold shadow-lg shadow-blue-100 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
          Submit for Approval
        </button>
        <p className="text-center text-[10px] text-gray-400 mt-4 font-medium italic">
          * Information once submitted cannot be changed until administrative review.
        </p>
      </div>
    </div>
  );
